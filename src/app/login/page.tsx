...
export default function LoginPage() {
  ...
  return (
    ...
    <AuthMotion>
      <AuthCard
        title="Welcome back"
        subtitle="Log in to your CookHub account"
      >
        {error && (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="px-3 py-2 rounded-md border border-(--color-border) bg-(--color-bg)
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              ...
              className="w-full pr-14 px-3 py-2 rounded-md border border-(--color-border)
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 text-sm
                    text-(--color-text-muted) hover:text-(--color-primary) z-10"
              >
